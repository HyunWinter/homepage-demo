  ...
  return (
    <footer className="border-b bg-white py-12 dark:bg-transparent">
      <div className="mx-auto max-w-5xl px-6">
        <div className="flex lg:flex-row flex-col lg:justify-between justify-center items-center gap-6">
          <span className="text-muted-foreground block text-center text-sm">
            © {new Date().getFullYear()} Latte Languages LLC, All rights reserved
          </span>
