...
export function HeroSection() {
  return (
    <section className="overflow-hidden">
        ...
        <div className="relative pt-24 md:pt-36">
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
              ...
              <TextEffect
                ...
                Learn your next Language with product-name
              </TextEffect>
              <TextEffect
                per="line"
                preset="fade-in-blur"
                ...
                Discover a new way to learn 14 languages with product-name's unique cultural short stories and interactive lessons.
              </TextEffect>
          ...
          <AnimatedGroup
            ...
            <div className="relative max-w-2xl mx-auto mt-8 overflow-hidden px-2 sm:mt-12 md:mt-20">
              ...
              />
              <Image
                className="z-2 border-border/25 h-auto w-full bg-cover relative rounded-2xl border"
                src={HeroImage}
                alt="app screen"
                width="2700"
                height="1440"
      ...
      {/* Clients */}
      <article className="bg-background pb-16 pt-16 md:pb-32">
